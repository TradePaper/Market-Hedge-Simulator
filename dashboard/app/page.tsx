      ...
      <header className="border-b border-[#21262d] bg-[#0d1117]/95 backdrop-blur sticky top-0 z-10">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-4">
          ...
          <div className="flex items-center gap-1.5 ml-2">
            ...
            <span className="px-1.5 py-0.5 rounded text-[10px] bg-[#161b22] border border-[#21262d] text-gray-400 font-mono">Mock — Simulated</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="bg-[#161b22] border border-[#21262d] rounded-lg p-4">
            ...
            <p className="text-xs text-gray-500 mb-3">
              Divergence is calculated as <span className="font-mono text-gray-300">Market Prob − Sportsbook Implied Prob</span>.
